    ...
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          ...
          className={cn(
            "absolute z-40 mt-2 w-56 rounded-xl bg-white p-1.5 shadow-lg border border-slate-200 ring-1 ring-black/5 focus:outline-none animate-in fade-in zoom-in-95 duration-150",
